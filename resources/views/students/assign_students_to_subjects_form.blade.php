...
<div class="max-w-md mx-auto mt-8 p-6 bg-white rounded shadow-md">
    <h1 class="text-2xl font-bold mb-4">Assign Student to Subject</h1>
    ...
    <form action="{{ route('assign.student.subject') }}" method="POST">
        @csrf
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Assign Student to Subject</button>
    </form>
</div>
@endsection
